...
export const IS_MAINNET: boolean =
  process.env.BLOCKCHAIN_EVM_NETWORK === "mainnet";
...
export const ADMIN_WALLET_PRIVATEKEY: string =
  process.env.ADMIN_WALLET_PRIVATEKEY;
export const ADMIN_WALLET_MNEMONIC: string = process.env.ADMIN_WALLET_MNEMONIC;

export const EVM_NETWORK_JSONRPC_ENDPOINT: string =
  process.env.EVM_NETWORK_JSONRPC_ENDPOINT;

export const ADMIN_WALLET_ACME_BALANCE: number = Number(
  process.env.ADMIN_WALLET_ACME_BALANCE
);
